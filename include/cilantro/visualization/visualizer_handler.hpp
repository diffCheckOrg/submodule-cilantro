...
struct VisualizerHandler : pangolin::Handler {
  ...
  virtual void PixelUnproject(pangolin::View& view, pangolin::GLprecision winx,
                              pangolin::GLprecision winy, pangolin::GLprecision winz,
                              pangolin::GLprecision Pc[3]);

  virtual void GetPosNormal(pangolin::View& view, int x, int y, pangolin::GLprecision p[3],
                            pangolin::GLprecision Pw[3], pangolin::GLprecision Pc[3],
                            pangolin::GLprecision nw[3], pangolin::GLprecision default_z = 1.0);

  void Keyboard(pangolin::View&, unsigned char key, int x, int y, bool pressed);

  void Mouse(pangolin::View&, pangolin::MouseButton button, int x, int y, bool pressed,
             int button_state);

  void MouseMotion(pangolin::View&, int x, int y, int button_state);

  void Special(pangolin::View&, pangolin::InputSpecial inType, float x, float y, float p1, float p2,
